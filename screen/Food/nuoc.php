...
// Lấy dữ liệu từ bảng danh_muc_do_an
$sql = "SELECT * FROM danh_muc_do_an";
...
<body>
    <header class="header bg-black relative align-center flex flex-col p-0">
        <div class="head-navigation flex align-center">
            ...
            <ul class="navigation-menu flex align-center">
                <li><a href="http://localhost/a/screen/index.html" class="text-white cursor-pointer decoration-none menu-text font-light home-navigation">Trang chủ</a></li>
                <li class="relative"><a href="" class="text-white cursor-pointer decoration-none menu-text font-light info-navigation">Tìm hiểu</a></li>
                <li class="relative"><a href="http://localhost/a/screen/Food/mainfood.php" class="text-white cursor-pointer decoration-none menu-text font-light food-navigation">Thực đơn</a></li>
                <li><a href="http://localhost/a/screen/discount.html" class="text-white cursor-pointer decoration-none menu-text font-light discount-navigation">Khuyến mãi</a></li>
                <li><a href="" class="text-white cursor-pointer decoration-none menu-text font-light news-navigation">Tin tức</a></li>
                <li><a href="" class="text-white cursor-pointer decoration-none menu-text font-light contact-navigation">Liên hệ</a></li>
            </ul>
            ...
            <div class="ml-10 flex gap-10">
                <div class="navbtn-store othernav-btn bg-primary flex align-center cursor-pointer">
                    ...
                    <div class="othernavbtn-content flex flex-col">
                        <p class="text-white">Hệ thống</p><span class="text-secondary">Cửa hàng</span>
                    </div>
                </div>
                <div class="navbtn-delivery othernav-btn bg-primary flex align-center cursor-pointer">
                    ...
                    <div class="othernavbtn-content flex flex-col">
                        <p class="text-white">Giao hàng</p><span class="text-secondary">Mc Delivery</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="Custom-Slider relative">
        <div class="submenu no-display  justify-center info absolute w-full align-center cursor-pointer">
            <div class="flex submenu-content justify-between  gap-10 ">
                <a href="" class="decoration-none text-center"><img src="http://localhost/a/assets/img/submenuImg/submenuItem.jpg" alt="">
                    <p class="text-white">Lịch sử</p>
                </a>
                <a href="" class="decoration-none text-center"><img src="http://localhost/a/assets/img/submenuImg/submenuItem1.jpg" alt="">
                    <p class="text-white">Giới thiệu</p>
                </a>
                <a href="" class="decoration-none text-center"><img src="http://localhost/a/assets/img/submenuImg/submenuItem2.jpg" alt="">
                    <p class="text-white">Xuất xứ</p>
                </a>
                <a href="" class="decoration-none text-center"><img src="http://localhost/a/assets/img/submenuImg/submenuItem3.jpg" alt="">
                    <p class="text-white">Nhà cung cấp</p>
                </a>
                <a href="" class="decoration-none text-center"><img src="http://localhost/a/assets/img/submenuImg/submenuItem4.jpg" alt="">
                    <p class="text-white">Dịch vụ</p>
                </a>
                <a href="" class="decoration-none text-center"><img src="http://localhost/a/assets/img/submenuImg/submenuItem5.jpg" alt="">
    ...
    <div class="mainscreen">
        <div class="menu-filtered-section justify-center flex j bg-dark-gray cursor-pointer menudefault">
            <div class="container flex">
                <!-- Món Chính -->
                <div class="relative grow text-center main-food" onclick="window.location.href='mainfood.php'">
                    <h2 class="font-light text-white">Món Chính</h2>
                    <!-- Xóa mọi thành phần liên quan đến dấu đỏ -->
                </div>

                <!-- Nước (Mục được chọn hiện tại) -->
                <div class="relative grow text-center main-food bg-red" style="background-color: red; color: white;">
                    <h2 class="font-light text-white">Nước</h2>
                </div>

                <!-- Tráng Miệng -->
                <div class="relative grow text-center main-food" onclick="window.location.href='trangmieng.php'">
                    <h2 class="font-light text-white">Tráng Miệng</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="menu-Items-section flex justify-center mt-55">
        <div class="container grid-1vs2 gap-20">
            <div class="food-content flex">
                <div class="food-content-bruh">
                    <h2 class="font-light text-primary">Thức uống</h2>
                    <p>Nước ngọt có ga các loại, sữa và nước suối</p>
                    <button onclick=" window.location.href='menunuoc.php'" class="font-light">Khám phá</button>
                </div>
                <img src="https://mcdonalds.vn/uploads/2018/food-categories/xdrink,281,29.png.pagespeed.ic.sqtimJ1LE_.webp" alt="">
            </div>
        </div>
    </div>
    </div>
    ...
    <div class="flex flex-col align-center mt-55">
        <div class="footer">
            <!-- Nội dung của footer -->
        </div>
