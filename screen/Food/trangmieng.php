    ...
    <div class="mainscreen">
        <div class="menu-filtered-section justify-center flex j bg-dark-gray cursor-pointer menudefault">
            <div class="container flex">
                ...
                <div class="relative grow text-center main-food" onclick="window.location.href='nuoc.php'" >
        ...
        <div class="container grid-1vs2 gap-20">
            <div class="food-content flex">
                <div class="food-content-bruh">
                    <h2 class="font-light text-primary">Tráng Miệng </h2>
                    <p>Kem cone, Sundae, McFlurry</p>
                    <button onclick=" window.location.href='menutrangmieng.php'" class="font-light">Khám phá</button>
                </div>
                <img src="https://mcdonalds.vn/uploads/2018/food-categories/xdessert,281,29.png.pagespeed.ic.XzMDQfILWO.webp" alt="">
            </div>
        </div>
    </div>
    </div>
