...
$loaiMonAn = "Tráng Miệng"; // Đặt loại đồ ăn là Tráng Miệng
...
<head>
    ...
    <title>Menu chính - Tráng Miệng</title>
</head>
<body>
    <header class="header bg-black relative align-center flex flex-col p-0">
        <div class="head-navigation flex align-center">
            ...
            <ul class="navigation-menu flex align-center">
                ...
                <li class="relative">
                    <a href="http://localhost/a/screen/Food/mainfood.html" class="text-white cursor-pointer decoration-none menu-text font-light food-navigation text-secondary">Thực đơn</a>
                </li>
                <li>
    ...
    <div class="menudetail-screen">
        <div class="flex justify-center mb-20">
            <div class="container">
                <h1 class="font-light"><?= htmlspecialchars($loaiMonAn); ?></h1>
